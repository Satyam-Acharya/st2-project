...
function func()
{
    ...
    for(var i=1;i<=3;i++)
    {
        ...
        if(document.getElementById(q).value=="")
        {
            alert("fill graduation details correctly");
            return;
        }
        else
        {
            if(i==1)
            {
                if(document.getElementById(q).value.length>10)
                {
                    alert("fill graduation name length correctly");
                    return;
                }
            }
            if(i==2)
    ...
    for(var i=1;i<=3;i++)
    {
        ...
        if(document.getElementById(q).value=="")
        {
            alert("fill masters details correctly");
            return;
        }
        else
        {
            if(i==1)
            {
                if(document.getElementById(q).value.length>10)
                {
                    alert("fill masters name length correctly");
                    return;
                }
            }
            if(i==2)
